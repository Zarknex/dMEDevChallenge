...
function PCBoxPage(): JSX.Element {
  ...
  return (
    <div className="bg-slate-200 flex flex-col items-center justify-start w-full h-full p-4 overflow-hidden">
      ...
      {!Array.isArray(pcBoxPokemons) ? (
        <p className="text-xl font-semibold text-red-600 text-center">
          Unable to connect to the database. <br />
          Please verify that the user exists, has the necessary permissions, and that the database has been created according to the file located at: <br />
          <code className="text-gray-800">src\backend\models\postgres.sql</code>
        </p>
